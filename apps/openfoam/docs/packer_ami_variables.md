...
The amis folder contains the packer scripts to a AWS Machine Image (AMI) of OpenFOAM.
It is organized by Operating System (OS) with folder name convention such as `OS-pc-openfoam`
...
| -------------------------- | ------------------------------------------------ | ------- | ---------------------- | -------- |
| application\_name          | Application name                                 | String  |    openfoam              | no       |
| application\_version       | OpenFOAM version                                   | String  | 2012      | no       |
